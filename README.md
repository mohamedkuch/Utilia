...
- PDF agent skill: <https://skills.sh/mohamedkuch/utilia-solana-agent/utilia-pdf-to-markdown>
- Smithery skill mirror: <https://smithery.ai/skills/medksbuss/utilia-pdf-to-markdown>
...
SOLANA_KEYPAIR_PATH=/absolute/path/to/agent-wallet.json \
  npx -y utilia-solana-agent@0.5.6 pdf-to-markdown \
